    ...
    const date = new Date()
        return (
            ...
            <div className="w-[220px]">
                ...
                <h3 className="font-bold hidden 2sm:block text-[18px] mb-2">Join Us</h3>
                <div className="hidden 2sm:flex items-center justify-between w-[200px]">
                    <a className="mr-[5px] block" href=""> <button className="text-sm hover:bg-[#ff320e] transition-all delay-500 rounded-[6rem] bg-[#F57059] mt-2 mx-auto justify-self-center place-self-center object-center text-white font-normal py-[14px] px-8">
              Connect Wallet
            </button> </a>
            </div>
                <div>
                <h3 className="font-bold hidden 2sm:block text-[18px] mt-5 mb-2">Company</h3>
